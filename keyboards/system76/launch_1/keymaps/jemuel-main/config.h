...
#define RGB_MATRIX_LAYER1_MODE RGB_MATRIX_SOLID_COLOR
#define RGB_MATRIX_LAYER1_HUE 142 // 200 degrees
#define RGB_MATRIX_LAYER1_SAT 0
...
// Layer 3 - Showing bound keys in red
#define RGB_MATRIX_LAYER3_MODE RGB_MATRIX_CUSTOM_active_keys
#define RGB_MATRIX_LAYER3_HUE 0 // 200 degrees
