...
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________||________|
  |            |        |        |        |        |        |        |        |        |        |   ;    |   '    |            |   |        |
  |    MO(1)   |   A    |   S    | ALT(D) |CTRL(F) |   G    |   H    |CTRL(J) | ALT(K) |   L    |   :    |   "    |   ENTER    |   |  END   |
...
*/
  ...
  [0] = LAYOUT(
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,      KC_PGDN,
        MO(2), KC_A,    KC_S,    LALT_T(KC_D),    LCTL_T(KC_F),    KC_G,    KC_H,    RCTL_T(KC_J),    RALT_T(KC_K),    KC_L,    KC_SCLN, KC_QUOT,    KC_ENT,           KC_END,
